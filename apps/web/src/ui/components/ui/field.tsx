...
const fieldVariants = cva(
  'group/field flex w-full gap-3 data-[invalid=true]:text-destructive-muted-foreground',
  {
    variants: {
      orientation: {
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn('text-sm font-normal text-destructive-muted-foreground', className)}
      {...props}
    >
      {content}
    </div>
