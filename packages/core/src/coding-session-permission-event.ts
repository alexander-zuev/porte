...
/** Canonical permission interaction event for one coding session. */
export const CodingSessionPermissionEventSchema = z.intersection(
  z.object({ eventId: EventIdSchema, sessionId: SessionIdSchema }),
  permissionEventDataSchema,
)

/** Canonical permission interaction event for one coding session. */
export type CodingSessionPermissionEvent = z.infer<typeof CodingSessionPermissionEventSchema>
