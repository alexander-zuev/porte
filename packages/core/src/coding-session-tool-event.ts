...
import { EventIdSchema, SessionIdSchema, ToolCallIdSchema, TurnIdSchema } from './identity.ts'
...
export const CodingSessionToolEventSchema = z.object({
...
/** Canonical full-state update for one coding-agent tool call. */
export type CodingSessionToolEvent = z.infer<typeof CodingSessionToolEventSchema>
